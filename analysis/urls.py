...
urlpatterns = [
	...
	# path('search/indivs/',  SearchIndivListView.as_view(), name='analysis-search-indivs'),
	# path('search/PACs/',  SearchPACListView.as_view(), name='analysis-search-PACs'),
	# path('search/sponsors/',  SearchSponsorListView.as_view(), name='analysis-search-sponsors'),
	# path('search/cosponsors/',  SearchCosponsorListView.as_view(), name='analysis-search-cosponsors'),
	# path('search/votes/',  SearchVoteListView.as_view(), name='analysis-search-votes'),
	#########
